(() => {
  ...
  style.textContent = '.search-toggle{border:0;background:transparent;color:#fff;display:grid;place-items:center;padding:5px;cursor:pointer}.search-toggle svg{width:21px;height:21px;stroke-width:1.5}.search-overlay{position:fixed;z-index:200;inset:0;background:rgba(52,9,9,.96);padding:calc(24px + env(safe-area-inset-top)) 22px 25px;color:#fff;opacity:0;pointer-events:none;transition:opacity .25s}.search-overlay.open{opacity:1;pointer-events:auto}.search-box{max-width:640px;margin:auto}.search-top{display:flex;gap:12px;align-items:center;border-bottom:1px solid rgba(255,255,255,.45);padding-bottom:13px}.search-top input{flex:1;min-width:0;background:transparent;border:0;outline:0;color:#fff;font:30px Cormorant Garamond,Georgia,serif}.search-top input::placeholder{color:#d8bda9}.search-close{flex:0 0 41px;width:41px;height:41px;border:1px solid rgba(255,255,255,.5);border-radius:50%;background:transparent;color:#fff;font-size:25px}.search-results{display:grid;gap:1px;margin-top:25px}.search-results a{padding:16px 3px;border-bottom:1px solid rgba(255,255,255,.18);font:20px Cormorant Garamond,Georgia,serif;letter-spacing:.06em;color:#fff}.search-results a small{display:block;margin-top:4px;font:9px DM Sans,Arial,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#d7ad6a}.search-empty{color:#e8cdbd;font:18px Cormorant Garamond,Georgia,serif;margin-top:25px}';
